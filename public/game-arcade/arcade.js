...
class ArcadeEngine {
  ...
  fitBoardToViewport() {
    ...
    const baseTileSize = parseFloat(styles.getPropertyValue('--tile-size-base')) || 46;
    const baseFontSize = parseFloat(styles.getPropertyValue('--tile-font-size-base')) || 19;
    const baseGap = parseFloat(styles.getPropertyValue('--board-gap-base')) || 6;
